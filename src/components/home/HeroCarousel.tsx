...
const slides = [
  {
    id: 1,
    image: '/images/hero-standee.jpg',
    badge: 'Premium Digital Standees',
    title: 'High-Impact <span class="text-transparent bg-clip-text bg-gradient-to-r from-signal-blue to-signal-blue-dark filter drop-shadow-[0_0_20px_rgba(30,111,235,0.4)]">LED Standees</span> for Retail',
    desc: 'Sleek, vibrant, and highly reliable digital advertising standees manufactured in Surat for upscale B2B retail environments.',
    primaryCta: 'View Standees',
  ...
  },
  {
    ...
    badge: 'Large Scale Displays',
    title: 'Custom <span class="text-transparent bg-clip-text bg-gradient-to-r from-signal-red to-[#b92828] filter drop-shadow-[0_0_20px_rgba(226,59,59,0.4)]">LED Video Walls</span>',
    desc: 'Bespoke indoor and outdoor LED video walls built with precision die-cast cabinets for zero-bezel alignment.',
    primaryCta: 'Display Solutions',
    primaryLink: '/display-and-signage',
    glowColor: 'bg-signal-red/20',
  },
  {
    id: 3,
    ...
    desc: 'In-house engineering, strict quality control, and scalable B2B manufacturing capabilities for all digital signage.',
    primaryCta: 'Our Facility',
    primaryLink: '/about',
