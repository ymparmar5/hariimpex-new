...
export const CATEGORIES: Category[] = [
  // Division A
  {
    id: 'c1', slug: 'led-video-walls', name: 'LED Video Walls & Displays', division: 'display',
  ...
  {
    id: 'c2', slug: 'digital-standees', name: 'Digital Standees & Signage', division: 'display',
  ...
  {
    id: 'c3', slug: 'led-scrolling-boards', name: 'LED Scrolling & Display Boards', division: 'display',
  ...
  {
    id: 'c4', slug: 'led-scoreboards', name: 'LED Scoreboards', division: 'display',
  ...
  {
    id: 'c5', slug: 'clip-on-acrylic-boards', name: 'Clip-On & Acrylic Boards', division: 'display',
  ...
  {
    id: 'c6', slug: 'aluminium-led-profiles', name: 'Aluminium & LED Structural Profiles', division: 'display',
  ...
  // Division B
  {
    id: 'c7', slug: 'water-cooling-blocks', name: 'CPU & Industrial Water Cooling Blocks', division: 'cooling',
  ...
  {
    id: 'c8', slug: 'radiators-heat-exchange', name: 'Radiators & Heat Exchange', division: 'cooling',
...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'p1', slug: 'outdoor-led-screen', name: 'Outdoor LED Screen', categorySlug: 'led-video-walls', division: 'display',
  ...
  {
    id: 'p2', slug: 'fixable-video-wall', name: 'Fixable Video Wall', categorySlug: 'led-video-walls', division: 'display',
  ...
  {
    id: 'p3', slug: 'indoor-led-display', name: 'Indoor LED Display', categorySlug: 'led-video-walls', division: 'display',
  ...
  {
    id: 'p4', slug: 'led-screen-standee', name: 'LED Screen Standee', categorySlug: 'digital-standees', division: 'display',
  ...
  {
    id: 'p5', slug: 'led-standee-32-inch', name: 'LED Standee, 32-inch, with charging socket', categorySlug: 'digital-standees', division: 'display',
  ...
  {
    id: 'p6', slug: 'running-led-display-board', name: 'Running LED Display Board', categorySlug: 'led-scrolling-boards', division: 'display',
  ...
  {
    id: 'p7', slug: 'led-display-module', name: 'LED Display Module', categorySlug: 'led-scrolling-boards', division: 'display',
  ...
  {
    id: 'p8', slug: 'gold-rate-led-display-board', name: 'Gold Rate LED Display Board', categorySlug: 'led-scrolling-boards', division: 'display',
  ...
  {
    id: 'p9', slug: 'clip-on-board', name: 'Aluminium Clip-On Board', categorySlug: 'clip-on-acrylic-boards', division: 'display',
  ...
  {
    id: 'p10', slug: 'copper-water-block-80x40', name: 'Copper Water Block, 80×40mm', categorySlug: 'water-cooling-blocks', division: 'cooling',
  ...
  {
    id: 'p11', slug: 'copper-water-block-top-nozzle', name: 'Copper Water Block, Top Nozzle', categorySlug: 'water-cooling-blocks', division: 'cooling',
  ...
  {
    id: 'p12', slug: 'cpu-water-cooling-radiator', name: 'CPU Water Cooling Radiator', categorySlug: 'radiators-heat-exchange', division: 'cooling',
  ...
  {
    id: 'p13', slug: 'condenser-coil-8x4', name: 'Condenser Coil, 8×4 inch', categorySlug: 'radiators-heat-exchange', division: 'cooling',
